generate_oncoprint <-  function(muts= muts, cnvs= NULL, svs= NULL ,  # define variants DFs
                                ...
                                cols.font= 18, rows.font= 18, pct.font= 16, legend.label.font= 10, legend.title.font= 14, fig.title.font= 18,  barplot.font= 10,  #****FONTs: row.groupname.font is the same as rows.font
  ...
  events <- factor(unique(data$EFFECT), levels=c("unknown","other_snvs","missense","splice_site_variant","complex","stop_gain","inframe_indel","frameshift_indel","AMP","DEL","LOH","INV","FUS","TRANS","TDUP","other_svs"))
  ...
  EFFECT <- list(variants = c("missense","stop_gain","frameshift_indel","inframe_indel","splice_site_variant","complex","unknown",  "AMP",     "DEL",  "LOH",  "INV",      "FUS",   "TRANS",           "other_svs","other_snvs","OTHER_SVs","multi_hit"), 
                    labels= c("Missense","Stop-gain","Frameshift indel","Inframe indel","Splicing variant","Complex",   "Unknown",  "CN Gain","CN Loss","LOH", "Inversion","Fusion","Translocation","Other SVs","Other SNVs","Other SVs","Multiple variants"))
